...
from kr_backend import email_pb2 as email__pb2
...
class EmailServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEmail = channel.unary_unary(
                '/emailinfo.EmailService/GetEmail',
...
def add_EmailServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'emailinfo.EmailService', rpc_method_handlers)
...
class EmailService(object):
    ...
    def GetEmail(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/emailinfo.EmailService/GetEmail',
