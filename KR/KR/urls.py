...
from kr_backend import api, views
...
urlpatterns = [
    ...
    path('api/login/', views.auth_view),
    path('api/logout/', views.logout_view),
    path('api/register/', views.register_view),
]

# def grpc_handlers(server):
#     post_info_pb2_grpc.add_PostInfoServiceServicer_to_server(api.PostInfoService.as_servicer(), server)
